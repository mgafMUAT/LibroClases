...
public class ActividadDAO {
	...
	public static Actividad loadActividadByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Actividad) session.load(com.mauro.librodeclases.Actividad.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Actividad getActividadByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Actividad) session.get(com.mauro.librodeclases.Actividad.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Actividad loadActividadByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Actividad) session.load(com.mauro.librodeclases.Actividad.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Actividad getActividadByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Actividad) session.get(com.mauro.librodeclases.Actividad.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Actividad createActividad() throws ParseException {
		return new com.mauro.librodeclases.Actividad("", "", "", "", false);
	}
	
	public static boolean save(com.mauro.librodeclases.Actividad actividad) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(actividad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.mauro.librodeclases.Actividad actividad) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(actividad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(com.mauro.librodeclases.Actividad actividad) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(actividad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.mauro.librodeclases.Actividad actividad) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(actividad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
