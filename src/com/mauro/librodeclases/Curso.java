...
public class Curso {
    ...
    private java.util.Set this_getSet(int key) {
        if (key == com.mauro.librodeclases.ORMConstants.KEY_CURSO_ALUMNOS) {
            return ORM_alumnos;
        }
    ...
    private void this_setOwner(Object owner, int key) {
        if (key == com.mauro.librodeclases.ORMConstants.KEY_CURSO_RAMO) {
            this.ramos.add((com.mauro.librodeclases.Ramo) owner);
        } else if (key == com.mauro.librodeclases.ORMConstants.KEY_CURSO_COLEGIO) {
            this.colegio = (com.mauro.librodeclases.Colegio) owner;
        }
    }
