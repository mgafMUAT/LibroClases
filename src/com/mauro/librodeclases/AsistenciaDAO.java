...
public class AsistenciaDAO {
	...
	public static Asistencia loadAsistenciaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Asistencia) session.load(com.mauro.librodeclases.Asistencia.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asistencia getAsistenciaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Asistencia) session.get(com.mauro.librodeclases.Asistencia.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asistencia loadAsistenciaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Asistencia) session.load(com.mauro.librodeclases.Asistencia.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asistencia getAsistenciaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Asistencia) session.get(com.mauro.librodeclases.Asistencia.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asistencia createAsistencia() throws ParseException {
		return new com.mauro.librodeclases.Asistencia("01-01-2001", false);
	}
	
	public static boolean save(com.mauro.librodeclases.Asistencia asistencia) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(asistencia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.mauro.librodeclases.Asistencia asistencia) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(asistencia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(com.mauro.librodeclases.Asistencia asistencia) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(asistencia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.mauro.librodeclases.Asistencia asistencia) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(asistencia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
