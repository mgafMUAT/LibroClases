...
public class ProfesorDAO {
	...
	public static Profesor loadProfesorByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Profesor) session.load(com.mauro.librodeclases.Profesor.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Profesor getProfesorByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Profesor) session.get(com.mauro.librodeclases.Profesor.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Profesor loadProfesorByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Profesor) session.load(com.mauro.librodeclases.Profesor.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Profesor getProfesorByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Profesor) session.get(com.mauro.librodeclases.Profesor.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Profesor createProfesor() {
		return new com.mauro.librodeclases.Profesor("", "");
	}
	
	public static boolean save(com.mauro.librodeclases.Profesor profesor) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.mauro.librodeclases.Profesor profesor) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(com.mauro.librodeclases.Profesor profesor)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(com.mauro.librodeclases.Profesor profesor, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (profesor.colegio != null) {
				profesor.colegio.profesores.remove(profesor);
			}
	...
	public static boolean refresh(com.mauro.librodeclases.Profesor profesor) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.mauro.librodeclases.Profesor profesor) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(profesor);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
