...
public class AlumnoDAO {
	...
	public static Alumno loadAlumnoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Alumno) session.load(com.mauro.librodeclases.Alumno.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Alumno getAlumnoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Alumno) session.get(com.mauro.librodeclases.Alumno.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Alumno loadAlumnoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Alumno) session.load(com.mauro.librodeclases.Alumno.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Alumno getAlumnoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Alumno) session.get(com.mauro.librodeclases.Alumno.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Alumno createAlumno() {
		return new com.mauro.librodeclases.Alumno("", "", 0, null);
	}
	
	public static boolean save(com.mauro.librodeclases.Alumno alumno) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(alumno);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.mauro.librodeclases.Alumno alumno) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(alumno);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(com.mauro.librodeclases.Alumno alumno)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(com.mauro.librodeclases.Alumno alumno, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (alumno.apoderado != null) {
				alumno.apoderado.pupilos.remove(alumno);
			}
	...
	public static boolean refresh(com.mauro.librodeclases.Alumno alumno) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(alumno);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.mauro.librodeclases.Alumno alumno) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(alumno);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
