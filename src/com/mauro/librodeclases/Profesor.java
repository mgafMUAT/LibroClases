...
public class Profesor extends Persona {
    ...
    private void this_setOwner(Object owner, int key) {
        if (key == com.mauro.librodeclases.ORMConstants.KEY_PROFESOR_RAMO) {
            this.ramo = (com.mauro.librodeclases.Ramo) owner;
        } else if (key == com.mauro.librodeclases.ORMConstants.KEY_PROFESOR_COLEGIO) {
