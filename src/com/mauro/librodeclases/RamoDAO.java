...
public class RamoDAO {
	...
	public static Ramo loadRamoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Ramo) session.load(com.mauro.librodeclases.Ramo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ramo getRamoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Ramo) session.get(com.mauro.librodeclases.Ramo.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ramo loadRamoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Ramo) session.load(com.mauro.librodeclases.Ramo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ramo getRamoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Ramo) session.get(com.mauro.librodeclases.Ramo.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ramo createRamo() {
		return new com.mauro.librodeclases.Ramo("", null);
	}
	
	public static boolean save(com.mauro.librodeclases.Ramo ramo) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(ramo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.mauro.librodeclases.Ramo ramo) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(ramo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(com.mauro.librodeclases.Ramo ramo)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(com.mauro.librodeclases.Ramo ramo, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (ramo.getProfesor() != null) {
				ramo.getProfesor().ramo = null;
			}
	...
	public static boolean refresh(com.mauro.librodeclases.Ramo ramo) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(ramo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.mauro.librodeclases.Ramo ramo) throws PersistentException {
		try {
			com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(ramo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
