...
import v1.com.mauro.librodeclases.Anotacion;
...
public class NuevaAnotacion extends javax.swing.JFrame {
    ...
    private void listo(boolean crea) {
        if (crea) {
            Anotacion anot = new Anotacion(observacion.getText(), positiva.isSelected());
            Principal.colegio.cursos.get(Principal.seleccion).alumnos.get(
                    Principal.numAlumno).anotaciones.add(anot);
        }
        this.dispose();
