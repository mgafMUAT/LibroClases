...
public class VerActividad extends javax.swing.JFrame {
    ...
    public VerActividad(int n) {
        actv = Principal.colegio.cursos.get(Principal.seleccion).ramos.get(
                Principal.numRamo).planificacion.get(n);
        initComponents();
        nombreActv.setText(actv.getNombre() + " Tipo: " + actv.getTipo());
        jTextArea1.setText(actv.getDescripcion());
        jTextArea1.setEditable(false);
        Evaluado.setText("Evaluado: " + (actv.isEvaluado() ? "Sí" : "No"));
    }
    ...
    private void initComponents() {
        ...
        Evaluado = new javax.swing.JLabel();
...
//    }
    ...
    private javax.swing.JLabel Evaluado;
