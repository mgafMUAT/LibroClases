...
import v1.com.mauro.librodeclases.Alumno;
...
public class NuevoAlumno extends javax.swing.JFrame {
    ...
    public NuevoAlumno() {
        ...
        Principal.apoderados.forEach((apoderado) -> {
            listaApod.addItem(apoderado.getNombre());
        });
    }
    ...
    private void listo(boolean crea) {
        if (crea) {
            ...
            if (apodNuevo.isSelected()) {
                al = new Alumno(nombreAlumno.getText(), rutAlumno.getText(),
                        (int) ingreso.getValue(), nombreApod.getText(), rutApod.getText());
            } else {
                al = new Alumno(nombreAlumno.getText(), rutAlumno.getText(),
                        (int) ingreso.getValue(), Principal.apoderados.get(listaApod.getSelectedIndex()));
            }
            Principal.colegio.cursos.get(Principal.seleccion).alumnos.add(al);
        }
        this.dispose();
