...
public class Alumno extends Persona {
    ...
    private java.util.Set this_getSet(int key) {
        if (key == v1.com.mauro.librodeclases.ORMConstants.KEY_ALUMNO_ANOTACIONES) {
    ...
    private void this_setOwner(Object owner, int key) {
        if (key == v1.com.mauro.librodeclases.ORMConstants.KEY_ALUMNO_CURSO) {
            this.curso = (v1.com.mauro.librodeclases.Curso) owner;
        } else if (key == v1.com.mauro.librodeclases.ORMConstants.KEY_ALUMNO_REGISTRO) {
            this.registro.add((v1.com.mauro.librodeclases.Asistencia) owner);
        } else if (key == v1.com.mauro.librodeclases.ORMConstants.KEY_ALUMNO_APODERADO) {
            this.apoderado = (v1.com.mauro.librodeclases.Apoderado) owner;
        } else if (key == v1.com.mauro.librodeclases.ORMConstants.KEY_ALUMNO_NOTA) {
            v1.com.mauro.librodeclases.Nota nota = (v1.com.mauro.librodeclases.Nota) owner;
