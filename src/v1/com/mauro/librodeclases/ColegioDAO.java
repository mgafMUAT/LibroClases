...
public class ColegioDAO {
	...
	public static Colegio loadColegioByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Colegio) session.load(v1.com.mauro.librodeclases.Colegio.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Colegio getColegioByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Colegio) session.get(v1.com.mauro.librodeclases.Colegio.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Colegio loadColegioByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Colegio) session.load(v1.com.mauro.librodeclases.Colegio.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Colegio getColegioByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Colegio) session.get(v1.com.mauro.librodeclases.Colegio.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Colegio createColegio() {
		return new v1.com.mauro.librodeclases.Colegio("", "");
	}
	
	public static boolean save(v1.com.mauro.librodeclases.Colegio colegio) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(colegio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v1.com.mauro.librodeclases.Colegio colegio) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(colegio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v1.com.mauro.librodeclases.Colegio colegio)throws PersistentException {
		try {
			v1.com.mauro.librodeclases.Curso[] lCursoss = (v1.com.mauro.librodeclases.Curso[]) colegio.cursos.toArray();
			for(int i = 0; i < lCursoss.length; i++) {
				lCursoss[i].colegio = null;
			}
			v1.com.mauro.librodeclases.Profesor[] lProfesoress = (v1.com.mauro.librodeclases.Profesor[]) colegio.profesores.toArray();
	...
	public static boolean deleteAndDissociate(v1.com.mauro.librodeclases.Colegio colegio, org.orm.PersistentSession session)throws PersistentException {
		try {
			v1.com.mauro.librodeclases.Curso[] lCursoss = (v1.com.mauro.librodeclases.Curso[]) colegio.cursos.toArray();
			for(int i = 0; i < lCursoss.length; i++) {
				lCursoss[i].colegio = null;
	...
	public static boolean refresh(v1.com.mauro.librodeclases.Colegio colegio) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(colegio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v1.com.mauro.librodeclases.Colegio colegio) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(colegio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
