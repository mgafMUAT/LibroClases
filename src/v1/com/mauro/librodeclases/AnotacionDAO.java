...
public class AnotacionDAO {
	...
	public static Anotacion loadAnotacionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Anotacion) session.load(v1.com.mauro.librodeclases.Anotacion.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotacion getAnotacionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Anotacion) session.get(v1.com.mauro.librodeclases.Anotacion.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotacion loadAnotacionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Anotacion) session.load(v1.com.mauro.librodeclases.Anotacion.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotacion getAnotacionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Anotacion) session.get(v1.com.mauro.librodeclases.Anotacion.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotacion createAnotacion() {
		return new v1.com.mauro.librodeclases.Anotacion("", false);
	}
	
	public static boolean save(v1.com.mauro.librodeclases.Anotacion anotacion) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(anotacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v1.com.mauro.librodeclases.Anotacion anotacion) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(anotacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(v1.com.mauro.librodeclases.Anotacion anotacion) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(anotacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v1.com.mauro.librodeclases.Anotacion anotacion) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(anotacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
