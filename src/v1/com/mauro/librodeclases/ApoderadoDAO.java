...
public class ApoderadoDAO {
	...
	public static Apoderado loadApoderadoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Apoderado) session.load(v1.com.mauro.librodeclases.Apoderado.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado getApoderadoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Apoderado) session.get(v1.com.mauro.librodeclases.Apoderado.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado loadApoderadoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Apoderado) session.load(v1.com.mauro.librodeclases.Apoderado.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado getApoderadoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Apoderado) session.get(v1.com.mauro.librodeclases.Apoderado.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado createApoderado() {
		return new v1.com.mauro.librodeclases.Apoderado("", "", null);
	}
	
	public static boolean save(v1.com.mauro.librodeclases.Apoderado apoderado) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().saveObject(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v1.com.mauro.librodeclases.Apoderado apoderado) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().deleteObject(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v1.com.mauro.librodeclases.Apoderado apoderado)throws PersistentException {
		try {
			v1.com.mauro.librodeclases.Alumno[] lAlumnoss = (v1.com.mauro.librodeclases.Alumno[]) apoderado.pupilos.toArray();
	...
	public static boolean deleteAndDissociate(v1.com.mauro.librodeclases.Apoderado apoderado, org.orm.PersistentSession session)throws PersistentException {
		try {
			v1.com.mauro.librodeclases.Alumno[] lAlumnoss = (v1.com.mauro.librodeclases.Alumno[]) apoderado.pupilos.toArray();
			for(int i = 0; i < lAlumnoss.length; i++) {
				lAlumnoss[i].apoderado = null;
	...
	public static boolean refresh(v1.com.mauro.librodeclases.Apoderado apoderado) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().refresh(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v1.com.mauro.librodeclases.Apoderado apoderado) throws PersistentException {
		try {
			v1.com.mauro.librodeclases.LibroClasesPersistentManager.instance().getSession().evict(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
