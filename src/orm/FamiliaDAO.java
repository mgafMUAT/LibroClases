...
public class FamiliaDAO {
	...
	public static Familia loadFamiliaByORMID(PersistentSession session, int id_pk) throws PersistentException {
		try {
			return (Familia) session.load(orm.Familia.class, new Integer(id_pk));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Familia getFamiliaByORMID(PersistentSession session, int id_pk) throws PersistentException {
		try {
			return (Familia) session.get(orm.Familia.class, new Integer(id_pk));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Familia loadFamiliaByORMID(PersistentSession session, int id_pk, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Familia) session.load(orm.Familia.class, new Integer(id_pk), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Familia getFamiliaByORMID(PersistentSession session, int id_pk, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Familia) session.get(orm.Familia.class, new Integer(id_pk), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Familia createFamilia() {
		return new orm.Familia();
	}
	
	public static boolean save(orm.Familia familia) throws PersistentException {
		try {
			orm.LibroClasePersistentManager.instance().saveObject(familia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Familia familia) throws PersistentException {
		try {
			orm.LibroClasePersistentManager.instance().deleteObject(familia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Familia familia)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(orm.Familia familia, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (familia.getEstudiante1_id_pk() != null) {
				familia.getEstudiante1_id_pk().familia.remove(familia);
			}
	...
	public static boolean refresh(orm.Familia familia) throws PersistentException {
		try {
			orm.LibroClasePersistentManager.instance().getSession().refresh(familia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Familia familia) throws PersistentException {
		try {
			orm.LibroClasePersistentManager.instance().getSession().evict(familia);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
