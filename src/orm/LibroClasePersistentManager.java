...
public class LibroClasePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "LibroClase";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new LibroClasePersistentManager();
		}
