...
public class ApoderadoDAO {
	...
	public static Apoderado loadApoderadoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Apoderado) session.load(v2.orm.Apoderado.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado getApoderadoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Apoderado) session.get(v2.orm.Apoderado.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado loadApoderadoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Apoderado) session.load(v2.orm.Apoderado.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado getApoderadoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Apoderado) session.get(v2.orm.Apoderado.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Apoderado createApoderado() {
		return new v2.orm.Apoderado();
	}
	
	public static boolean save(v2.orm.Apoderado apoderado) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Apoderado apoderado) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Apoderado apoderado)throws PersistentException {
		try {
			if (apoderado.getPersona_id_fk() != null) {
				apoderado.getPersona_id_fk().setApoderado(null);
			}
			
			v2.orm.Estudiante[] lEstudiantes = apoderado.estudiante.toArray();
	...
	public static boolean deleteAndDissociate(v2.orm.Apoderado apoderado, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (apoderado.getPersona_id_fk() != null) {
				apoderado.getPersona_id_fk().setApoderado(null);
			}
	...
	public static boolean refresh(v2.orm.Apoderado apoderado) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Apoderado apoderado) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(apoderado);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
