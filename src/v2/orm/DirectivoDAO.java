...
public class DirectivoDAO {
	...
	public static Directivo loadDirectivoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Directivo) session.load(v2.orm.Directivo.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Directivo getDirectivoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Directivo) session.get(v2.orm.Directivo.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Directivo loadDirectivoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Directivo) session.load(v2.orm.Directivo.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Directivo getDirectivoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Directivo) session.get(v2.orm.Directivo.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Directivo createDirectivo() {
		return new v2.orm.Directivo();
	}
	
	public static boolean save(v2.orm.Directivo directivo) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(directivo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Directivo directivo) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(directivo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Directivo directivo)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(v2.orm.Directivo directivo, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (directivo.getPersona_id_fk() != null) {
				directivo.getPersona_id_fk().setDirectivo(null);
			}
	...
	public static boolean refresh(v2.orm.Directivo directivo) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(directivo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Directivo directivo) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(directivo);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
