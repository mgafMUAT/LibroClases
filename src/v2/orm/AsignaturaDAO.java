...
public class AsignaturaDAO {
	...
	public static Asignatura loadAsignaturaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Asignatura) session.load(v2.orm.Asignatura.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asignatura getAsignaturaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Asignatura) session.get(v2.orm.Asignatura.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asignatura loadAsignaturaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Asignatura) session.load(v2.orm.Asignatura.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asignatura getAsignaturaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Asignatura) session.get(v2.orm.Asignatura.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Asignatura createAsignatura() {
		return new v2.orm.Asignatura();
	}
	
	public static boolean save(v2.orm.Asignatura asignatura) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(asignatura);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Asignatura asignatura) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(asignatura);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Asignatura asignatura)throws PersistentException {
		try {
			...
			v2.orm.Actividad[] lActividads = asignatura.actividad.toArray();
	...
	public static boolean deleteAndDissociate(v2.orm.Asignatura asignatura, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (asignatura.getCurso_id_fk() != null) {
				asignatura.getCurso_id_fk().asignatura.remove(asignatura);
			}
	...
	public static boolean refresh(v2.orm.Asignatura asignatura) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(asignatura);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Asignatura asignatura) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(asignatura);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
