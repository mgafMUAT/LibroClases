...
public class NotaDAO {
	...
	public static Nota loadNotaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Nota) session.load(v2.orm.Nota.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Nota getNotaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Nota) session.get(v2.orm.Nota.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Nota loadNotaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Nota) session.load(v2.orm.Nota.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Nota getNotaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Nota) session.get(v2.orm.Nota.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Nota createNota() {
		return new v2.orm.Nota();
	}
	
	public static boolean save(v2.orm.Nota nota) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(nota);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Nota nota) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(nota);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Nota nota)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(v2.orm.Nota nota, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (nota.getActividad_id_fk() != null) {
				nota.getActividad_id_fk().setNota(null);
			}
	...
	public static boolean refresh(v2.orm.Nota nota) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(nota);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Nota nota) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(nota);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
