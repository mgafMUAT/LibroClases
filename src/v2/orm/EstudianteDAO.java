...
public class EstudianteDAO {
	...
	public static Estudiante loadEstudianteByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Estudiante) session.load(v2.orm.Estudiante.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Estudiante getEstudianteByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Estudiante) session.get(v2.orm.Estudiante.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Estudiante loadEstudianteByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Estudiante) session.load(v2.orm.Estudiante.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Estudiante getEstudianteByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Estudiante) session.get(v2.orm.Estudiante.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Estudiante createEstudiante() {
		return new v2.orm.Estudiante();
	}
	
	public static boolean save(v2.orm.Estudiante estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Estudiante estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Estudiante estudiante)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(v2.orm.Estudiante estudiante, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (estudiante.getPersona_id_fk() != null) {
				estudiante.getPersona_id_fk().setEstudiante(null);
			}
	...
	public static boolean refresh(v2.orm.Estudiante estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Estudiante estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
