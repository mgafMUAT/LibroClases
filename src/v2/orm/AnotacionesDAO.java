...
public class AnotacionesDAO {
	...
	public static Anotaciones loadAnotacionesByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Anotaciones) session.load(v2.orm.Anotaciones.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotaciones getAnotacionesByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Anotaciones) session.get(v2.orm.Anotaciones.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotaciones loadAnotacionesByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Anotaciones) session.load(v2.orm.Anotaciones.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotaciones getAnotacionesByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Anotaciones) session.get(v2.orm.Anotaciones.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anotaciones createAnotaciones() {
		return new v2.orm.Anotaciones();
	}
	
	public static boolean save(v2.orm.Anotaciones anotaciones) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(anotaciones);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Anotaciones anotaciones) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(anotaciones);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Anotaciones anotaciones)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(v2.orm.Anotaciones anotaciones, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (anotaciones.getEstudiante_id_fk() != null) {
				anotaciones.getEstudiante_id_fk().anotaciones.remove(anotaciones);
			}
	...
	public static boolean refresh(v2.orm.Anotaciones anotaciones) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(anotaciones);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Anotaciones anotaciones) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(anotaciones);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
