...
public class Nota {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == v2.orm.ORMConstants.KEY_NOTA_ACTIVIDAD_ID_FK) {
			this.actividad_id_fk = (v2.orm.Actividad) owner;
		}
		
		else if (key == v2.orm.ORMConstants.KEY_NOTA_ESTUDIANTE_ID_FK) {
	...
	private v2.orm.Actividad actividad_id_fk;
	...
	public void setActividad_id_fk(v2.orm.Actividad value) {
		if (this.actividad_id_fk != value) {
			v2.orm.Actividad lactividad_id_fk = this.actividad_id_fk;
	...
	public v2.orm.Actividad getActividad_id_fk() {
