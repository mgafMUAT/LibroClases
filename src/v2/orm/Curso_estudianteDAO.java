...
public class Curso_estudianteDAO {
	...
	public static Curso_estudiante loadCurso_estudianteByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Curso_estudiante) session.load(v2.orm.Curso_estudiante.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Curso_estudiante getCurso_estudianteByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Curso_estudiante) session.get(v2.orm.Curso_estudiante.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Curso_estudiante loadCurso_estudianteByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Curso_estudiante) session.load(v2.orm.Curso_estudiante.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Curso_estudiante getCurso_estudianteByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Curso_estudiante) session.get(v2.orm.Curso_estudiante.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Curso_estudiante createCurso_estudiante() {
		return new v2.orm.Curso_estudiante();
	}
	
	public static boolean save(v2.orm.Curso_estudiante curso_estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().saveObject(curso_estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(v2.orm.Curso_estudiante curso_estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().deleteObject(curso_estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(v2.orm.Curso_estudiante curso_estudiante)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(v2.orm.Curso_estudiante curso_estudiante, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (curso_estudiante.getCurso_id_fk() != null) {
				curso_estudiante.getCurso_id_fk().curso_estudiante.remove(curso_estudiante);
			}
	...
	public static boolean refresh(v2.orm.Curso_estudiante curso_estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().refresh(curso_estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(v2.orm.Curso_estudiante curso_estudiante) throws PersistentException {
		try {
			v2.orm.LibroClasePersistentManager.instance().getSession().evict(curso_estudiante);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
